...
public class CrearBindividual extends javax.swing.JPanel {
    int opcion;
    private static Libros[] listalibros = new Libros[2];
    public CrearBindividual() {
        initComponents();
         initComponents2();
    ...
    private void initComponents() {
        ...
        Pfondo.add(labelcrearb, new org.netbeans.lib.awtextra.AbsoluteConstraints(-1, 23, 930, 40));
        ...
        Pfondo.add(labertitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 240, 130, 30));
        ...
        Pfondo.add(txtdescrip, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 290, 270, 30));
        ...
        Pfondo.add(labeltema, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 440, 130, 30));
        ...
        Pfondo.add(labeledicion, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 390, 130, 30));
        ...
        Pfondo.add(labelyear, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 190, 130, 30));
        ...
        Pfondo.add(labeldescrip, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 290, 140, 30));
        ...
        Pfondo.add(laberpclave, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 340, 140, 30));
        ...
        Pfondo.add(Separator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 220, 270, 20));

        Separator4.setForeground(new java.awt.Color(0, 39, 78));
        Pfondo.add(Separator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 270, 270, 20));

        Separator5.setForeground(new java.awt.Color(0, 39, 78));
        Pfondo.add(Separator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 370, 270, 20));

        Separator7.setForeground(new java.awt.Color(0, 39, 78));
        Pfondo.add(Separator7, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 420, 270, 20));
        ...
        Pfondo.add(txtyear, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 190, 270, 30));
        ...
        Pfondo.add(txttema, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 440, 270, 30));
        ...
        Pfondo.add(txttitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 240, 270, 30));
        ...
        Pfondo.add(ingresar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 490, 130, 40));

        Separator6.setForeground(new java.awt.Color(0, 39, 78));
        Pfondo.add(Separator6, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 320, 270, 20));

        txtclave.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        txtclave.setForeground(new java.awt.Color(0, 12, 23));
        txtclave.setBorder(null);
        Pfondo.add(txtclave, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 340, 270, 30));
        ...
        Pfondo.add(txtedicion, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 390, 270, 30));
        ...
        Pfondo.add(labelcopia, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 90, 130, 30));
        ...
        Pfondo.add(labelarea, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 140, 130, 30));
        ...
        Pfondo.add(labelcategoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 190, 130, 30));
        ...
        Pfondo.add(labelejemplar, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 240, 130, 30));
        ...
        Pfondo.add(labelisbn, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 290, 130, 30));
        ...
        Pfondo.add(txtautor, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 140, 270, 30));
        ...
        Pfondo.add(txtcopias, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 90, 270, 30));

        txtarea.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        txtarea.setForeground(new java.awt.Color(153, 153, 153));
        txtarea.setBorder(null);
        Pfondo.add(txtarea, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 140, 270, 30));

        txtcategoria.setFont(new java.awt.Font("Roboto", 0, 12)); // NOI18N
        txtcategoria.setForeground(new java.awt.Color(153, 153, 153));
        txtcategoria.setBorder(null);
        Pfondo.add(txtcategoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 190, 270, 30));
        ...
        Pfondo.add(txtejemplar, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 240, 270, 30));
        ...
        Pfondo.add(txtisbn, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 290, 270, 30));
        ...
        Pfondo.add(Separator8, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 470, 270, 10));

        Separator9.setForeground(new java.awt.Color(0, 39, 78));
        Pfondo.add(Separator9, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 120, 270, 20));

        Separator10.setForeground(new java.awt.Color(0, 39, 78));
        Pfondo.add(Separator10, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 170, 270, 20));

        Separator11.setForeground(new java.awt.Color(0, 39, 78));
        Pfondo.add(Separator11, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 220, 270, 20));

        Separator12.setForeground(new java.awt.Color(0, 39, 78));
        Pfondo.add(Separator12, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 270, 270, 20));

        Separator13.setForeground(new java.awt.Color(0, 39, 78));
        Pfondo.add(Separator13, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 320, 270, 20));
        ...
        Pfondo.add(labelautor1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 140, 130, 30));

        Separator15.setForeground(new java.awt.Color(0, 39, 78));
        Pfondo.add(Separator15, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 170, 270, 20));
